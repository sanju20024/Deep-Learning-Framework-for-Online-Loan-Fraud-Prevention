...
main = tkinter.Tk()
main.title("DEEP LEARNING FRAMEWORK FOR ONLINE LOAN FRAUD PREVENTION") 
...
font = ('times', 16, 'bold')
title = Label(main, text='DEEP LEARNING FRAMEWORK FOR ONLINE LOAN FRAUD PREVENTION', justify=LEFT)
